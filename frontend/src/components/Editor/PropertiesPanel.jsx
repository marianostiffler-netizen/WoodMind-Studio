      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <label className="text-sm font-medium text-gray-300">Wood Type</label>
          </div>
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <label className="text-sm font-medium text-gray-300">Dimensions (cm)</label>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs text-gray-400 block mb-1">Thickness</label>
              <input
                type="number"
                min="0.5"
                max="10"
            ...
            <div>
              <label className="text-xs text-gray-400 block mb-1">Orientation</label>
              <select
        ...
        <div className="bg-gray-700 rounded-lg p-4">
          <div className="flex items-center mb-3">
            ...
            <label className="text-sm font-medium text-gray-300">Price Calculation</label>
          </div>
        ...
        <div className="bg-gray-700 rounded-lg p-4">
          <div className="flex items-center mb-3">
            ...
            <label className="text-sm font-medium text-gray-300">Production Time</label>
          </div>
